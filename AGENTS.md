...
- 판매 상품은 **핵심노트**와 **시험대비 완성패키지** 2개만 운영한다.
- 핵심노트 기본 출시가: **5,900원**
- 시험대비 완성패키지 기본 출시가: **9,900원**
- 실제 운영 가격은 관리자 페이지에서 SKU별로 변경하며, 결제 Source of Truth는 `products.price_krw`다.
- 핵심노트 = 핵심개념 요약노트 + 공식·수치 한눈표 + 시험 직전 체크리스트
- 시험대비 완성패키지 = 핵심노트 전체 + 상세 개념해설서 + 단원별 확인문제·해설
- 내부 SKU/파일 코드는 CORE/PASS/PASS PACK/SHEET/CHECK를 유지한다.
