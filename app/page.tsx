      ...
      <section className="hero section">
        <div className="container hero-grid">
          <div className="hero-copy">
            ...
            <p className="hero-lead">긴 교재를 다시 읽는 대신, 마지막 회독에 필요한 핵심만 정리합니다. PASSMATE는 자격증별 핵심요약·치트시트·시험직전 체크리스트를 한 번에 제공합니다.</p>
            ...
            <div className="trust-row">
              ...
              <span>✓ 공식·숫자 치트시트</span>
            </div>
          </div>
          <div className="hero-panel" aria-hidden="true">
            <div className="floating-card card-a"><b>CORE</b><span>핵심요약</span></div>
            <div className="floating-card card-b"><b>CHECK</b><span>시험직전</span></div>
      ...
      <section className="section section-soft">
        <div className="container">
          ...
          <div className="feature-grid">
            ...
            <article className="feature-card"><span>02</span><h3>SHEET</h3><p>공식·숫자처럼 반복 암기가 필요한 내용을 빠르게 확인하는 치트시트.</p></article>
            <article className="feature-card feature-card-dark"><span>03</span><h3>CHECK</h3><p>시험장에서 놓치기 쉬운 항목을 마지막으로 점검하는 체크리스트.</p></article>
          </div>
        </div>
      </section>
      ...
      <section className="section section-soft">
        <div className="container">
          ...
          <div className="feature-grid">
            ...
            <article className="feature-card"><span>STEP 2</span><h3>암기</h3><p>SHEET로 공식·숫자와 헷갈리는 개념을 반복해서 확인합니다.</p></article>
            <article className="feature-card feature-card-dark"><span>STEP 3</span><h3>점검</h3><p>CHECK로 놓치기 쉬운 항목을 마지막에 확인하고 시험장으로 갑니다.</p></article>
          </div>
        </div>
      </section>
    </>
